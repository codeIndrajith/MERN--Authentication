  ...
  return (
    <FormController>
      <div className="flex flex-col h-[125vh] lg:w-full lg:h-screen sm:flex-row md:flex lg:mb-20 xl:w-full xl:h-screen justify-center items-center p-6">
        {/* image section */}
        <div className="flex flex-col justify-center items-center w-full h-screen sm:mb-[5rem] md:w-[50%] sm:w-[120%] md:p-2 lg:p-7 lg:h-screen lg:w-full xl:h-screen xl:w-full xl:mt-8 space-y-2">
          <img
        ...
        {/* form section */}
        <div className="flex flex-col justify-center items-center w-full sm:mb-[5rem] md:w-[50%] lg:w-full lg:h-screen xl:w-full xl:h-screen md:p-2 lg:p-7 space-y-2">
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-3">
            ...
            {/* Go link to login page section */}
            <div className="flex justify-between items-center mt-5 md:mt-10 ml-0 md:ml-10">
              <p className="text-xs md:text-sm  md:ml-0 text-black">
                Already a member?
              </p>
              <Link
                to="/login"
